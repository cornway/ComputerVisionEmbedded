 ...
 * @{
 */
/* RGB Color format definition for JPEG encoding/Decoding : Should not be
 * modified*/
 ...
 */
#define JPEG_RGB_FORMAT                                                        \
  CONFIG_STM32_JPEG_RGB_FORMAT /* JPEG_ARGB8888, JPEG_RGB888, JPEG_RGB565, Gray ********* Value       \
 ...
 */
#define JPEG_SWAP_RG                                                           \
  0 /* 0 or 1 ********* Value different from default value : 0 ********** */
